...
export default function CrearBitacoraPersonal() {
        ...
        <FormContainer>
            <StyledCard>
                <StyledCardHeader
                    ...
                    title="Crear Bitácora Personal"
                />
                <StyledCardContent>
                    <Typography variant="body2" color="textSecondary">
                        Completa los campos para crear una nueva bitácora personal.
                    </Typography>
                    <form onSubmit={handleSubmit}>
                        <StyledSelect
                            name="id_empleado"
                            value={bitacora.id_empleado}
                        ...
                        />
                        <StyledInput
                            type="text" // Cambio realizado aquí
                            name="accion"
                            placeholder="Accion"
